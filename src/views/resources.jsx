...
export function Resources() {
  const resources_page_btn_links=data_links_buttons.Resources
  ...
  const content=(
    <div className="flex flex-col w-full items-center h-full bg-[var(--main-content-bg-color)]">
          <section className="flex flex-col items-center w-73 sm:w-112">
            ...
            <h3 className="pt-5 text-xl font-semibold text-[#54c0eb]">Mi ruta</h3>
            <div className="text-center w-full text-[var(--text-color)] text-sm my-5">
            Aqui veras la ruta que he tomado para el aprendizaje de varias tecnologias "python, javascript, etc" y otros enlaces para aprender
            </div>
